...
def build_schema() -> CollectionSchema:
    ...
    fields = [
        ...
        FieldSchema(name="source_type",  dtype=DataType.VARCHAR,        max_length=32),   # "jira" | "confluence"
        FieldSchema(name="title",        dtype=DataType.VARCHAR,        max_length=512),
        FieldSchema(name="content",      dtype=DataType.VARCHAR,        max_length=4096),
        FieldSchema(name="space",        dtype=DataType.VARCHAR,        max_length=128),  # "" for Jira docs
        FieldSchema(name="priority",     dtype=DataType.VARCHAR,        max_length=16),   # "" for Confluence
        FieldSchema(name="jira_type",    dtype=DataType.VARCHAR,        max_length=32),   # "" for Confluence
        ...
        FieldSchema(name="trap_group",   dtype=DataType.VARCHAR,        max_length=64),   # "" if not a trap doc
...
OUTPUT_FIELDS = [
    ...
    "space", "priority", "jira_type", "created_date", "updated_date", "trap_group",
]
